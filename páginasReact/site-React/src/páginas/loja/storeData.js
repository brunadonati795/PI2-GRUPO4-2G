...
const storeData = [
  { id: 1, name: "Acessório para fixação vertical", category: "loja", image:{lojaacessorioparafixaçãovertical}, preco: 25.0 },
  { id: 2, name: "Barra de estrutura", category: "loja", image:{lojabarraestrutura}, preco: 30.0 },
  { id: 3, name: "Estrutura para solo", category: "loja", image:{lojaestruturasolo}, preco: 45.0 },
  { id: 4, name: "Fixador de grampo", category: "loja", image:{lojafixadorgrampo}, preco: 10.0 },
