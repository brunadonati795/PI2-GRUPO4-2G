...
const storeData = [
{ id: 1, name: "Acessório para fixação vertical", category: "loja", image: lojaacessorioparafixaçãovertical, preco: 25.0, description: "Acessório de alumínio para fixação vertical de painéis solares. Dimensões: 12cm x 4cm x 3cm. Ideal para instalação segura em estruturas verticais." },
  { id: 2, name: "Barra de estrutura", category: "loja", image: lojabarraestrutura, preco: 30.0, description: "Barra de aço galvanizado de alta resistência. Comprimento: 1 metro, largura: 5cm, espessura: 0,5cm. Suporta cargas de painéis solares em telhados e solo." },
